...
import { Award, Users, Star, Sparkles, Heart } from "lucide-react";
...
const TrustBadges = () => {
  ...
  const badges = [
    ...
    { icon: Sparkles, title: t("trustBadges.guarantee"), description: t("trustBadges.guaranteeDesc") },
    { icon: Heart, title: t("trustBadges.fast"), description: t("trustBadges.fastDesc") },
  ];
